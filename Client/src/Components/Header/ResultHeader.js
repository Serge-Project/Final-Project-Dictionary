...
import '../Header/ResultHeader.css'
...
function Header(props) {
  ...
  return (
    <div className='bannerContainer'>
                <span className={Dictio_styles} onClick={HandleDictio}> <p className='dictionary'>Your Dictionary</p> </span>
                ...
                <a href="#synonym"  className={Sim_styles} onClick={HandleSim}>Similarity</a>
                <a href="#language" className={Trans_styles} onClick={HandleTrans}>English--Chinese</a>
        </div>
  )
}
